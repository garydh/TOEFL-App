...
import com.example.gerdev.toefllearningapp.Model_Set_get.Grammar;
import com.example.djakaumbarawurung.persipantestcept.R;
import com.example.gerdev.toefllearningapp.database.DataSource_PenghubungTabel;
import com.example.gerdev.toefllearningapp.database.SQLiteHelper;
 ...
 private DataSource_PenghubungTabel dataSource_penghubungTabel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(dataSource_penghubungTabel.hitungrecordOpsi()== 0) {
            ...
            dataSource_penghubungTabel.insertDataKeOpsi(15, "C.contribute", 4);
            ...
            dataSource_penghubungTabel.insertDataKeOpsi(25, "A.their", 7);
            dataSource_penghubungTabel.insertDataKeOpsi(26, "B.her", 7);
            dataSource_penghubungTabel.insertDataKeOpsi(27, "C.it`s", 7);
            dataSource_penghubungTabel.insertDataKeOpsi(28, "D.its", 7);
            dataSource_penghubungTabel.insertDataKeOpsi(29, "A.which", 8);
            dataSource_penghubungTabel.insertDataKeOpsi(30, "B.who", 8);
            dataSource_penghubungTabel.insertDataKeOpsi(31, "C.whom", 8);
            dataSource_penghubungTabel.insertDataKeOpsi(32, "D.what", 8);
        }
...
//----------- START OF READING PART
    ...
    public void tampilkanSoalGrammar(View view) {
        Intent intent = new Intent(ActivityHome.this, ActivityKuisGrammar.class);
        startActivity(intent);
    }

    public void paketSoalReading(View view) {
        Intent intent = new Intent(ActivityHome.this, ActivityKuisReading2.class);
        startActivity(intent);
    }

    public void paketSoalListening(View view) {
        Intent intent = new Intent(ActivityHome.this, ActivityListening.class);
        startActivity(intent);
    }

    public void paketSoalListeningB(View view) {
        Intent intent = new Intent(ActivityHome.this, ActivityListeningPartB.class);
        startActivity(intent);
    }
